...
if __name__ == "__main__":
    ...
    dataset_Oregon = {"name": "Oregon",
                 ...
                 "gt_dir": "./data/Oregon/oregon/train/index",
                 "im_ext": ".png",
                 "gt_ext": ".png",
                 "im_ch4_dir": "./data/oregon/oregon/train/feature_map",
                 "im_ch5_dir": "./data/oregon/oregon/train/glcm",
                 }
    ...
    #              "im_ch5_dir": "./data/Washington/Washington/glcm-entropy",
    #              }
    ...
    #              "im_ext": ".png",
    #              "gt_ext": ".png",
    #              "im_ch4_dir": "./data/BodegaBay/BodegaBay/glcm",
    #              "im_ch5_dir": "./data/BodegaBay/BodegaBay/feature_map"}
    # dataset_Alaska = {"name": "Alaska",
    #              "im_dir": "./data/Alaska/Alaska/train/image",
    #              "gt_dir": "./data/Alaska/Alaska/train/index",
    #              "im_ext": ".png",
    #              "gt_ext": ".png",
    #              "im_ch4_dir": "./data/Alaska/Alaska/train/feature_map",
    #              "im_ch5_dir": "./data/Alaska/Alaska/train/glcm",
    #              }
    ...
    dataset_Oregon_val = {"name": "Oregon",
                 ...
                 "im_ext": ".png",
                 "gt_ext": ".png",
                 "im_ch4_dir": "./data/Oregon/Oregon/test/feature_map",
                 "im_ch5_dir": "./data/Oregon/Oregon/test/glcm",
                 }
    # dataset_Washington_val = {"name": "Washington",
    #              "im_dir": "./data/Washington/Washington/test/image",
    #              "gt_dir": "./data/Washington/Washington/test/index",
    #              "im_ext": ".png",
    #              "gt_ext": ".png",
    #              "im_ch4_dir": "./data/Washington/Washington/glcm-entropy",
    #              "im_ch5_dir": "./data/Washington/Washington/glcm-entropy",
    ...
    #              "im_ext": ".png",
    #              "gt_ext": ".png",
    #              "im_ch4_dir": "./data/Alaska/Alaska/test/feature_map",
    #              "im_ch5_dir": "./data/Alaska/Alaska/test/glcm",
    #              }
